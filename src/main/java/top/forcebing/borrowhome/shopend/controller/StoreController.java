...
public class StoreController {
    ...
    public Object createStore(@RequestParam String Authorization, @RequestParam String storeClassification, @RequestParam String storeName, @RequestParam String storeHeading, @RequestParam(required = false) String storeBanner) {
        ...
        store.setClassification(storeClassification);
